...
public class MainActivity extends AppCompatActivity {
	...
	protected void onStart(){
		super.onStart();
		Toast.makeText( context: this, text: "Application on Start",Toast.LENGTH_SHORT).show();
	}
	...
	protected void onStop(){
		super.onStop();
		Toast.makeText( context: this, text: "Application on Stop",Toast.LENGTH_SHORT).show();
	}
